        ...
        <div className="container hero-grid">
          <div>
            ...
            <div className="button-row">
              <Link href="/shop" className="button button-dark">Shop now</Link>
              <Link href="/about" className="button button-light">About us</Link>
            </div>
          </div>
      ...
      <section className="section section-soft">
        <div className="container">
          <div className="section-head">
            ...
            <Link href="/shop" className="text-link">Alles ansehen</Link>
          </div>
